...
export default function AdminDashboardPage() {
  ...
  return <section className="mx-auto max-w-[1450px]">
    ...
    {error && !data ? <div className="border border-red-800/40 bg-red-950/15 p-10 text-center"><p className="text-sm text-red-200">{error}</p><button type="button" onClick={() => void load()} className="mt-5 bg-[#D4AF37] px-6 py-3 text-[9px] uppercase tracking-[.16em] text-black">Retry</button></div> : loading && !data ? <DashboardSkeleton/> : <>
