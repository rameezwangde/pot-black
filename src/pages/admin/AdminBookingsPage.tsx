...
export default function AdminBookingsPage() {
  ...
  return <section className="mx-auto max-w-[1550px]">
    ...
    {error && !bookings.length ? <div className="border border-red-800/40 p-10 text-center"><p className="text-sm text-red-200">{error}</p><button type="button" onClick={() => void loadBookings()} className="mt-5 bg-[#D4AF37] px-6 py-3 text-[9px] uppercase text-black">Retry</button></div> : loading ? <BookingListSkeleton/> : !bookings.length ? <div className="border border-white/10 p-14 text-center text-sm text-gray-500">No bookings found.</div> : <>
