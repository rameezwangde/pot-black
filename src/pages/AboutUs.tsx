...
export default function AboutUs() {
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0505]">
      {/* Page Header */}
      <section className="relative pt-32 pb-16 px-4 sm:px-6 sm:pt-40 sm:pb-20 lg:px-8 overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="group relative bg-[#0d0707] p-6 sm:p-8 md:p-14 border border-white/5 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-[#D4AF37]/20 hover:shadow-[0_20px_40px_-15px_rgba(212,175,55,0.05)]"
            >
      ...
      {/* Our Core Values */}
      <section className="py-14 sm:py-20 relative border-t border-white/5 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="relative bg-[#0d0707]/60 backdrop-blur-md p-6 sm:p-8 lg:p-10 border border-white/10 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-[#D4AF37]/40 hover:shadow-[0_20px_40px_-15px_rgba(212,175,55,0.15)] group rounded-sm"
              >
                {/* Decorative gradient orb */}
      ...
      <section className="py-16 sm:py-24 relative overflow-hidden bg-[#050202]">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-auto md:auto-rows-[300px]">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="min-h-[300px] lg:col-span-2 group relative overflow-hidden rounded-sm border border-white/5 bg-[#1A0E0E]"
            >
            ...
            <motion.div 
              ...
              className="min-h-[360px] lg:row-span-2 group relative overflow-hidden rounded-sm border border-white/5 bg-[#1A0E0E]"
            >
              ...
              <div className="absolute bottom-0 left-0 p-5 sm:p-8 md:p-10 w-full">
                <div className="bg-[#D4AF37]/20 p-3 rounded-full inline-block mb-4 border border-[#D4AF37]/30 backdrop-blur-md">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="min-h-[300px] group relative overflow-hidden rounded-sm border border-white/5 bg-[#1A0E0E]"
            >
