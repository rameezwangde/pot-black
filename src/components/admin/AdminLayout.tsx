...
export default function AdminLayout() {
  ...
  const pageTitle = location.pathname.startsWith('/admin/bookings') ? 'Booking Management' : location.pathname.startsWith('/admin/tables') ? 'Table Management' : location.pathname.startsWith('/admin/walk-ins') ? 'Walk-In Management' : 'Overview';
